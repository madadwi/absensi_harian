...
{{-- <link type="text/css" href="/css/admin/tambah-page.css" rel="stylesheet" /> --}}
...
<div class="tambah-page">
    <form action="">
        ...
        <div class="bg-table bg-table-btn" align="center">
            ...
            <a href="/admin/siswa"><button class="btn-kembali"><i class="fas fa-arrow-circle-left"></i> Kembali</button></a>
        </div>
    </form>
</div>