        ...
        <table>
            ...
            <form action="{{ route('rombels.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <tr>
                    ...
                    <td><input class="input1" style="margin-left: 5px;" type="text" name="rombel" placeholder="Masukan Nama Rombel.."></td>
                </tr>
        </table>
    </div>
    <div class="bg-table bg-table-btn" align="center">
        <button type="submit">Tambahkan</button>
        <a href="{{ route('rombels.index') }}"><button class="btn-kembali" type="button"><i class="fas fa-arrow-circle-left"></i> Kembali</button></a>
    </div>
