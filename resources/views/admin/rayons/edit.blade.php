        ...
        <table>
            ...
            <form action="{{ route('rayons.update',$rayon->id) }}" method="POST" enctype="multipart/form-data">
                ...
                <tr>
                    ...
                    <td><input class="input1" style="margin-left: 5px;" type="text" name="rayon" placeholder="Masukan Nama Rayon.." value="{{$rayon->rayon}}"> </td>
                </tr>
        </table>
    </div>
    <div class="bg-table bg-table-btn" align="center">
        <button type="submit">Tambahkan</button>
        <a href="{{ route('rayons.index') }}"><button class="btn-kembali"><i class="fas fa-arrow-circle-left"></i> Kembali</button></a>
    </div>
