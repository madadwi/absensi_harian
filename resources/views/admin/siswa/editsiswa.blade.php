...
<div class="tambah-page">
    <form action="{{ route('students.update', $siswa->id) }}" method="POST" enctype="multipart/form-data">
        @csrf
        @method('PUT')
        <div class="bg-table">
            @if ($errors->any())
            ...
            <table>
                ...
                <tr>
                    <td><input value="{{ old('nis', $siswa->nis) }}" class="input1" type="number" name="nis" placeholder="Masukan NIS.."></td>
                ...
                <tr>
                    <td>
                        <select name="rombel_id">
                            ...
                            <option {{ $row->id == old('rombel_id', $siswa->rombel_id) ? 'selected' : '' }} value="{{ $row->id }}">
                                {{ $row->rombel }}
                            </option>
                            @endforeach
                        </select>
                    ...
                    <td>
                        <select name="rayon_id">
                            ...
                            <option {{ $row->id == old('rayon_id', $siswa->rayon_id) ? 'selected' : '' }} value="{{ $row->id }}">
                                {{ $row->rayon }}
                            </option>
                            @endforeach
                        </select>
